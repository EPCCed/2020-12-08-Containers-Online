...
Download the [`docker-intro.zip`]({{ page.root }}/files/docker-intro.zip). _This file can alternatively be downloaded from the `files` directory in the [course GitHub repository](https://github.com/EPCCed/2020-12-08-Containers-Online)._
